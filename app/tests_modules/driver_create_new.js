let DriverCreateNew = async (browser, page, typeWork,strLastName, strFirstName, strMiddleName) => {
    const nameTest = 'DriverCreateNew->"' + strLastName + '"';
...
//---------------
        ...
        //Вводим Отчество
        resOk = await TypeByXPath(page, xpMiddleName, strMiddleName);
        if (!resOk) {
        ...
        resOk = await TypeByXPath(page, xpDriverLicenseNumber, strDriverLicenseNumber);
        if (!resOk) {
...
module.exports.DriverCreateNew = DriverCreateNew;
class DataCfoFields {
 ...
 // ['ColName' , 'IName', 'X' , 'DDF']
            ...
            ['Ф.О. безнал (З)',                            'client_cash_false_payment_form',           '',  'ClientFreights[X].Amount',  '1',  ''],
 ...
 //---->    ['РНН (З)',                                    'client_rnn',                               '',  '',  '',  ''],  // <------- Hidden
            ...
            ['Тип транспорта (П)',                         'transporter_vehicle_types',                '',  '',  '',  ''],
            ...
            ['Тонаж (П)',                                  'transporter_max_capacity',                 '',  '',  '',  ''],
            ['Объем (П)',                                  'transporter_volume',                       '',  '',  '',  ''],
            ['Марка авто (П)',                             'transporter_car_brand',                    '',  '',  '',  ''],
            ['Номера машины/полуприцепа (П)',              'transporter_numbers',                     '1',  '',  '',  ''],
            ['Юр. лицо. (П)',                              'transporter_legal_entity',                 '',  'strOurCompanyWithTransporter',  '=',  ''],
            ['Фрахт. нал (П)',                             'transporter_cash_true',                    '',  '',  '',  ''],
            ...
            ['Дата выгрузки',                              'transporter_date_unloading',               '',  '',  '',  ''],
            ['Трек ТТН',                                   'ttn_track',                                '',  '',  '',  ''],
            ...
            ['Номер вкладки',                              'inset',                                    '',  '',  '',  ''],
            ['Отв. менеджер',                              'responsible_salesman',                     '',  '',  '',  ''],
            ['Логист',                                     'logistical',                               '',  '',  '',  ''],
            ['Комиссия',                                   'commission',                               '',  '',  '',  ''],
            ['Груз',                                       'cargo_type',                               '',  '',  '',  ''],
            ['Тоннаж клиента',                             'own_weight',                               '',  '',  '',  ''],
            ['Стоимость груза, грн',                       'cargo_cost',                               '',  '',  '',  ''],
